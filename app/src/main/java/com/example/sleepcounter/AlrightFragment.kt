...
import com.example.sleepcounter.databinding.FragmentAlrightBinding
 ...
 */
class AlrightFragment : Fragment() {

    private lateinit var _binding: FragmentAlrightBinding;
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAlrightBinding.inflate(inflater, container, false)
        return binding.root
    }
