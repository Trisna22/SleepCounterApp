...
import com.example.sleepcounter.databinding.FragmentPffBinding
 ...
 */
class PffFragment : Fragment() {

    private lateinit var _binding: FragmentPffBinding;
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPffBinding.inflate(inflater, container, false)
        return binding.root
    }
